  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <main class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="max-w-md mx-auto bg-white rounded-lg shadow p-6">
        ...
        <form @submit="handleChangePassword" class="space-y-4" novalidate>
          ...
          <div>
            ...
            <div class="relative">
              <Field
                ...
                :class="errors.current_password ? 'border-red-300 text-red-900 focus:border-red-500' : 'border-gray-300 text-gray-900 focus:border-indigo-500'"
              ...
              <button
                ...
                :class="errors.current_password ? 'mt-1' : 'mt-1'"
